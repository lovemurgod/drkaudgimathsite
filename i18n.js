(function () {
  ...
  const TRANSLATIONS = {
    ...
    hi: {
      ...
      'meta.index.title': 'डॉ. आर. जी. करुडगिमठ मेमोरियल नर्सिंग होम | बादामी',
      'meta.index.description': 'डॉ. आर. जी. करुडगिमठ मेमोरियल नर्सिंग होम, बादामी - 24/7 इमरजेंसी और एम्बुलेंस के साथ विश्वसनीय बहु-विशेषज्ञ चिकित्सा सेवा।',
      'meta.appointment.title': 'अपॉइंटमेंट बुक करें | डॉ. आर. जी. करुडगिमठ मेमोरियल नर्सिंग होम',
      'meta.appointment.description': 'डॉ. आर. जी. करुडगिमठ मेमोरियल नर्सिंग होम में अपॉइंटमेंट बुक करें।',
      'meta.complaint.title': 'शिकायत दर्ज करें | डॉ. आर. जी. करुडगिमठ मेमोरियल नर्सिंग होम',
      ...
      'common.brandHomeAria': 'Dr. R. G. Karudagimath Memorial Nursing Home home',
      'common.brandName': 'डॉ. आर. जी. करुडगिमठ मेमोरियल नर्सिंग होम',
      ...
      'common.hospitalNameBadami': 'डॉ. आर. जी. करुडगिमठ मेमोरियल नर्सिंग होम, बादामी',
      ...
      'index.contact.mapTitle': 'डॉ. आर. जी. करुडगिमठ मेमोरियल नर्सिंग होम का स्थान दिखाने वाला मानचित्र',
      ...
      'index.founder.caption': 'संस्थापक: डॉ. जी. बी. करुडगिमठ',
      'index.founderImageAlt': 'संस्थापक डॉ. जी. बी. करुडगिमठ',
      ...
      'index.legacy.successorImageAlt': 'Dr. Rajashekar G. Karudagimath',
      'index.legacy.successorTitle': 'दृष्टि को आगे बढ़ाते हुए: डॉ. राजशेखर जी. करुडगिमठ',
    ...
    kn: {
      ...
      'meta.index.title': 'ಡಾ. ಆರ್. ಜಿ. ಕರಡಗಿಮಠ ಮೆಮೋರಿಯಲ್ ನರ್ಸಿಂಗ್ ಹೋಮ್ | ಬಾದಾಮಿ',
      'meta.index.description': 'ಡಾ. ಆರ್. ಜಿ. ಕರಡಗಿಮಠ ಮೆಮೋರಿಯಲ್ ನರ್ಸಿಂಗ್ ಹೋಮ್, ಬಾದಾಮಿ - 24/7 ತುರ್ತು ಮತ್ತು ಆಂಬುಲೆನ್ಸ್ ಸೇವೆಯೊಂದಿಗೆ ವಿಶ್ವಾಸಾರ್ಹ ಬಹು-ವಿಶೇಷ ಚಿಕಿತ್ಸಾ ಸೇವೆ.',
      'meta.appointment.title': 'ಅಪಾಯಿಂಟ್ಮೆಂಟ್ ಬುಕ್ ಮಾಡಿ | ಡಾ. ಆರ್. ಜಿ. ಕರಡಗಿಮಠ ಮೆಮೋರಿಯಲ್ ನರ್ಸಿಂಗ್ ಹೋಮ್',
      'meta.appointment.description': 'ಡಾ. ಆರ್. ಜಿ. ಕರಡಗಿಮಠ ಮೆಮೋರಿಯಲ್ ನರ್ಸಿಂಗ್ ಹೋಮ್‌ನಲ್ಲಿ ಅಪಾಯಿಂಟ್ಮೆಂಟ್ ಬುಕ್ ಮಾಡಿ.',
      'meta.complaint.title': 'ದೂರು ಸಲ್ಲಿಸಿ | ಡಾ. ಆರ್. ಜಿ. ಕರಡಗಿಮಠ ಮೆಮೋರಿಯಲ್ ನರ್ಸಿಂಗ್ ಹೋಮ್',
      ...
      'common.brandHomeAria': 'Dr. R. G. Karudagimath Memorial Nursing Home home',
      'common.brandName': 'ಡಾ. ಆರ್. ಜಿ. ಕರಡಗಿಮಠ ಮೆಮೋರಿಯಲ್ ನರ್ಸಿಂಗ್ ಹೋಮ್',
      'common.callAmbulanceAria': 'ಈಗ ಆಂಬುಲೆನ್ಸ್ ಕರೆ ಮಾಡಿ',
      'common.daysLabel': 'ದಿನಗಳು:',
      'common.fileComplaint': 'ದೂರು ಸಲ್ಲಿಸಿ',
      'common.footerLogoAlt': 'Dr. R. G. Karudagimath Memorial Nursing Home footer logo',
      'common.home': 'ಮುಖಪುಟ',
      'common.hospitalNameBadami': 'ಡಾ. ಆರ್. ಜಿ. ಕರಡಗಿಮಠ ಮೆಮೋರಿಯಲ್ ನರ್ಸಿಂಗ್ ಹೋಮ್, ಬಾದಾಮಿ',
      ...
      'index.contact.mapTitle': 'ಡಾ. ಆರ್. ಜಿ. ಕರಡಗಿಮಠ ಮೆಮೋರಿಯಲ್ ನರ್ಸಿಂಗ್ ಹೋಮ್‌ನ ಸ್ಥಳವನ್ನು ತೋರಿಸುವ ನಕ್ಷೆ',
      ...
      'index.doctors.name.vinayak': 'ಡಾ. ವಿನಾಯಕ ಮುಗಳಖೋಡ್',
      'index.doctors.name.ajay': 'ಡಾ. ಅಜಯ್ ಟಿ. ನಾಯ್ಕ',
      'index.doctors.name.santoshDesai': 'ಡಾ. ಸಂತೋಷ್ ಬಿ. ದೇಸಾಯಿ',
      'index.doctors.name.revanasiddappa': 'ಡಾ. ಬಿ.ಎಚ್. ರೇವಣಸಿದ್ದಪ್ಪ',
      'index.doctors.name.kirankumar': 'ಡಾ. ಕಿರಣಕುಮಾರ್ ಎಸ್. ಕುಳಗೇರಿ',
      'index.doctors.name.jayant': 'ಡಾ. ಜಯಂತ್ ಕುಮಾರ್',
      'index.doctors.name.pradeep': 'ಡಾ. ಪ್ರದೀಪ್ ನಂದಿ',
      'index.doctors.name.abhinandan': 'ಡಾ. ಅಭಿನಂದನ್ ಬಿ.',
      'index.doctors.name.santoshMalashetti': 'ಡಾ ಸಂತೋಷ್ ಮಲಶೆಟ್ಟಿ',
      'index.doctors.name.anirudh': 'ಡಾ. ಅನಿರುದ್ಧ್ ಎ. ಮಲ್ಲಾಪುರ',
      'index.doctors.name.vinod': 'ಡಾ. ವಿನೋದ್ ಅಕ್ಕಸಾಲಿ',
      'index.doctors.name.tohid': 'ಡಾ. ತೋಹೀದ್ ಕಾಜಿ',
      ...
      'index.founder.caption': 'ಸ್ಥಾಪಕರು: ಡಾ. ಜಿ. ಬಿ. ಕರಡಗಿಮಠ',
      'index.founderImageAlt': 'ಸ್ಥಾಪಕರು ಡಾ. ಜಿ. ಬಿ. ಕರಡಗಿಮಠ',
      ...
      'index.legacy.founderBody': 'ಡಾ. ಜಿ. ಬಿ. ಕರಡಗಿಮಠರು ವಿಶ್ವಾಸಾರ್ಹ, ನೈತಿಕ ಮತ್ತು ರೋಗಿ-ಕೇಂದ್ರೀಕೃತ ಚಿಕಿತ್ಸೆಯ ದೃಷ್ಟಿಯಿಂದ ಈ ಆಸ್ಪತ್ರೆಯನ್ನು ಸ್ಥಾಪಿಸಿದರು. ಬಲವಾದ ಮೌಲ್ಯಗಳು ಮತ್ತು ದಶಕಗಳ ವೈದ್ಯಕೀಯ ಅನುಭವದ ಆಧಾರದಲ್ಲಿ ಅವರು ಕರುಣೆ, ಶಿಸ್ತು ಮತ್ತು ಕ್ಲಿನಿಕಲ್ ಶ್ರೇಷ್ಠತೆಯ ಮೇಲೆ ನಿಂತ ಸಂಸ್ಥೆಯ ಅಡಿಪಾಯ ಹಾಕಿದರು. ಸಂಯೋಜಿತ ಚಿಕಿತ್ಸೆ, ಪಾರದರ್ಶಕತೆ ಮತ್ತು ಮಾನವೀಯ ಸೇವೆಯ ಮೇಲಿನ ಅವರ ಬದ್ಧತೆ ಇಂದು ಕೂಡ ಆಸ್ಪತ್ರೆಯ ಮಾನದಂಡಗಳನ್ನು ರೂಪಿಸುತ್ತಿದೆ. ಸಮುದಾಯಕ್ಕೆ ವಿಶ್ವಾಸ, ಮಾನ ಮತ್ತು ಸಮರ್ಪಣೆಯೊಂದಿಗೆ ಸೇವೆ ಸಲ್ಲಿಸುವುದು ಅವರ ದೃಷ್ಟಿಯ ಕೇಂದ್ರವಾಗಿದೆ.',
      'index.legacy.founderImageAlt': 'Dr. G. B. Karudagimath, founder of the hospital',
      'index.legacy.successorBody1': 'ಡಾ. ರಾಜಶೇಖರ ಜಿ. ಕರಡಗಿಮಠರು ಒಂದು ಶ್ರೇಷ್ಠ ವೈದ್ಯಕೀಯ ಪರಂಪರೆಯ ನಿರಂತರತೆಯನ್ನು ಪ್ರತಿನಿಧಿಸುತ್ತಾರೆ. ಡಾ. ಜಿ. ಬಿ. ಕರಡಗಿಮಠ ಮಲ್ಟಿಸ್ಪೆಷಾಲಿಟಿ ಆಸ್ಪತ್ರೆಯ ದ್ವಿತೀಯ ತಲೆಮಾರಿನ ನಾಯಕತ್ವವಾಗಿ ಅವರು ಆಧುನಿಕ ವೈದ್ಯಕೀಯ ಪರಿಣತಿಯನ್ನು ಸಂಸ್ಥೆಯ ಶಾಶ್ವತ ಮೌಲ್ಯಗಳೊಂದಿಗೆ ಸಮನ್ವಯಗೊಳಿಸಿದ್ದಾರೆ. ಪ್ರಗತಿಪರ ದೃಷ್ಟಿಕೋನ ಮತ್ತು ರೋಗಿ-ಕೇಂದ್ರೀಕೃತ ಆರೈಕೆಯ ಗೌರವದಿಂದ ಅವರು ಆಸ್ಪತ್ರೆಯ ವಿಶ್ವಾಸ, ಸುರಕ್ಷತೆ ಮತ್ತು ನೈತಿಕ ವೈದ್ಯಕೀಯ ಬದ್ಧತೆಯನ್ನು ಮತ್ತಷ್ಟು ಬಲಪಡಿಸಿದ್ದಾರೆ.',
      ...
      'index.legacy.successorImageAlt': 'Dr. Rajashekar G. Karudagimath',
      'index.legacy.successorTitle': 'ದೃಷ್ಟಿಯನ್ನು ಮುಂದುವರಿಸುತ್ತಾ: ಡಾ. ರಾಜಶೇಖರ ಜಿ. ಕರಡಗಿಮಠ',
